...
```
PYTHONPATH=./app python3 app/scripts/inference.py --inference_config configs/inference/test.yaml 
```
```
...
```
PYTHONPATH=./app python3 app/scripts/inference.py --inference_config configs/inference/test.yaml --bbox_shift xx  # where xx is in [-9, 9].
```
