...
LOCALES : Locales =\
{
	'en':
	{
		...
		'uis':
		{
			...
			'face_mask_occlusion_checkbox': 'OCCLUSION MASKING',
			...
			'save_as_default_button': 'SAVE AS DEFAULT',
			'save_as_default_error': 'Failed to save defaults: {error}',
			'save_as_default_status': 'Saved defaults to {config_path}',
			'source_file': 'SOURCE',
			'start_button': 'START',
			'stop_button': 'STOP',
