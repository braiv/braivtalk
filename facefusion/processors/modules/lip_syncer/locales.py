...
LOCALES : Locales =\
{
	'en':
	{
		'help':
		{
			...
			'crop_stabilization': 'smooth the face crop alignment across nearby frames to reduce whole-face wobble',
		...
		'uis':
		{
			...
			'crop_stabilization_slider': 'LIP SYNCER CROP STABILIZATION',
